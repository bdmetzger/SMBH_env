...
\newcommand{\vwNormC}{\frac{\vwO}{500 \, {\rm km/s}}}
...
%{\bf NCS: here is some added detail about the role of stellar mass functions in the model}
...
%Thus, for $\Mbh=10^6 \Msun$, we may have $\vwO\simeq 100$ km/s with heating mostly coming from main sequence winds. On the other hand, for $\Mbh \gsim 10^8 \Msun$, we may have $\vwO\simeq 500$ km/s, with the main contribution coming from type Ia SNe. These two regimes are illustrated in Figure~\ref{fig:vw_eff}.
%\end{enumerate}
