...
\item \emph{Type Ia SNe} From he energy injected per Ia SNe, $E_{\rm Ia}d}$ ergs, and the SNe rate,  $R_{\rm Ia}
...
There will be some radius, $r_{\rm Ia}$, where the dynamical timescale of the flow becomes comparable to the time between successive Type Ia SNe.  If the stagnation radius ($\rs$) of the flow is outside of $\rIa$ then SNes will provide a steady contribution to $\vwO$
...
%%AG-Plot comparing stagnation radius and Ia radius for all profiles...I found this to be confusing/hard to explain.
